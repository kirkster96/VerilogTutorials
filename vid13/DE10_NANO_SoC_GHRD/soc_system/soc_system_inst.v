	soc_system u0 (
		...
		.alu_a_export                          (<connected-to-alu_a_export>),                          //                          alu_a.export
		.alu_b_export                          (<connected-to-alu_b_export>),                          //                          alu_b.export
		.alu_cntl_export                       (<connected-to-alu_cntl_export>),                       //                       alu_cntl.export
		.alu_result_export                     (<connected-to-alu_result_export>)                      //                     alu_result.export
	);
